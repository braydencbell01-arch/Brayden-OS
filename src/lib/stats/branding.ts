...
export const LEAGUE_BRAND_COLORS: Record<LeagueId, string> = {
  ...
  'uefa-champions-qual': '#1a2f6e',
  'uefa-europa-qual': '#d4891a',
  'uefa-conference-qual': '#167a5c',
  ...
  'fifa-worldq': '#326295',
  'uefa-nations-a': '#0b1f4a',
  'uefa-nations-b': '#122a5c',
  'uefa-nations-c': '#1a356e',
  'uefa-nations-d': '#224080',
  'uefa-euro': '#003399',
  'uefa-euro-qual': '#1a4a9e',
