...
const SUGGESTED_TEAMS: readonly SuggestedTeam[] = [
  ...
  { id: '448', name: 'England', shortName: 'England', leagueId: 'uefa-nations-a', kind: 'national' },
  ...
  { id: '478', name: 'France', shortName: 'France', leagueId: 'uefa-nations-a', kind: 'national' },
  { id: '132', name: 'Bayern Munich', shortName: 'Bayern', leagueId: 'bundesliga', kind: 'club' },
  { id: '164', name: 'Spain', shortName: 'Spain', leagueId: 'uefa-nations-a', kind: 'national' },
  { id: '160', name: 'Paris Saint-Germain', shortName: 'PSG', leagueId: 'ligue-1', kind: 'club' },
  { id: '481', name: 'Germany', shortName: 'Germany', leagueId: 'uefa-nations-a', kind: 'national' },
  { id: '382', name: 'Manchester City', shortName: 'Man City', leagueId: 'premier-league', kind: 'club' },
  { id: '162', name: 'Italy', shortName: 'Italy', leagueId: 'uefa-nations-a', kind: 'national' },
  { id: '359', name: 'Arsenal', shortName: 'Arsenal', leagueId: 'premier-league', kind: 'club' },
  { id: '482', name: 'Portugal', shortName: 'Portugal', leagueId: 'uefa-nations-a', kind: 'national' },
  { id: '363', name: 'Chelsea', shortName: 'Chelsea', leagueId: 'premier-league', kind: 'club' },
  { id: '449', name: 'Netherlands', shortName: 'Netherlands', leagueId: 'uefa-nations-a', kind: 'national' },
  { id: '111', name: 'Juventus', shortName: 'Juventus', leagueId: 'serie-a', kind: 'club' },
  { id: '459', name: 'Belgium', shortName: 'Belgium', leagueId: 'uefa-nations-a', kind: 'national' },
  ...
  { id: '477', name: 'Croatia', shortName: 'Croatia', leagueId: 'uefa-nations-a', kind: 'national' },
  { id: '139', name: 'Ajax', shortName: 'Ajax', leagueId: 'eredivisie', kind: 'club' },
  { id: '479', name: 'Denmark', shortName: 'Denmark', leagueId: 'uefa-nations-a', kind: 'national' },
