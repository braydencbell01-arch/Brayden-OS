...
/** Clash-style trophy road — arenas, chests, gold, card unlocks. */
export const TROPHY_ROAD: TrophyRoadReward[] = [
  { trophies: 0, arena: 'Goblin Boot', label: 'Start your journey', gold: 50, unlockCard: 'finley' },
  ...
  { trophies: 150, arena: 'Goblin Boot', label: 'Rare Chest', chest: 'rare' },
  { trophies: 200, arena: 'Training Camp', label: 'Arena unlocked', gold: 100, unlockCard: 'lynne' },
  { trophies: 300, arena: 'Training Camp', label: 'Common Chest', chest: 'common', gold: 40 },
  { trophies: 400, arena: 'Training Camp', label: 'Unlock Kathie', unlockCard: 'kathie', gold: 75 },
  { trophies: 500, arena: 'Training Camp', label: 'Epic Chest', chest: 'epic' },
  { trophies: 600, arena: 'Sundae Strip', label: 'Arena unlocked', gold: 150, unlockCard: 'mike' },
  { trophies: 750, arena: 'Sundae Strip', label: 'Rare Chest', chest: 'rare', gold: 60 },
  { trophies: 900, arena: 'Sundae Strip', label: 'Unlock Todd', unlockCard: 'todd', gold: 100 },
  { trophies: 1000, arena: 'Sundae Strip', label: 'Legendary Chest', chest: 'legendary' },
  ...
  { trophies: 1800, arena: 'Bone Bridge', label: 'Rare Chest', chest: 'rare', gold: 100 },
  ...
  { trophies: 3000, arena: 'Royal Yard', label: 'Legendary Chest', chest: 'legendary', gold: 150 },
  ...
  { trophies: 5000, arena: 'Phil Peak', label: 'Champion Chest', chest: 'legendary', gold: 500 },
]
