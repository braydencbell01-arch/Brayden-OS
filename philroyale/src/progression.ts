...
export const TROPHY_ROAD: TrophyRoadReward[] = [
  ...
  { trophies: 540, arena: 'Training Camp', label: 'x1 Chicken', unlockCard: 'chicken', gold: 50 },
  ...
  { trophies: 585, arena: 'Training Camp', label: 'x1 Chicken Army', unlockCard: 'chickenArmy', gold: 70 },
  { trophies: 590, arena: 'Training Camp', label: 'x1 Chicken Barrel', unlockCard: 'chickenBarrel', gold: 80 },
  ...
  { trophies: 1325, arena: "Pete's Pit", label: 'x8 Chicken', cardCopies: { charId: 'chicken', copies: 8 } },
  { trophies: 1350, arena: "Pete's Pit", label: 'x5 Hamburger Chicken', cardCopies: { charId: 'hamburgerChicken', copies: 5 } },
  { trophies: 1375, arena: "Pete's Pit", label: 'x4 Chicken Army', cardCopies: { charId: 'chickenArmy', copies: 4 } },
  { trophies: 1385, arena: "Pete's Pit", label: 'x4 Chicken Barrel', cardCopies: { charId: 'chickenBarrel', copies: 4 } },
