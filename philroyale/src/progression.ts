...
export const TROPHY_ROAD: TrophyRoadReward[] = [
  ...
  { trophies: 1200, arena: 'Bone Bridge', label: 'x1 Pete', gold: 200, unlockCard: 'dan' },
  ...
  { trophies: 1600, arena: 'Bone Bridge', label: 'x1 Chuck', unlockCard: 'pete', gold: 125 },
  ...
  { trophies: 2000, arena: 'Royal Yard', label: 'x1 Jeremy', gold: 250, unlockCard: 'jeremy' },
